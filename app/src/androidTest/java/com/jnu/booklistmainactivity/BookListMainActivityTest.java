...
import com.jnu.booklistmainactivity.BookListMainActivity;
...
public class BookListMainActivityTest {
    ...
    @Rule
    public ActivityTestRule<BookListMainActivity> mActivityTestRule
            = new ActivityTestRule<>(BookListMainActivity.class);

    @Test
    public void showBookListMainActivityTest() {
        List<Book> listBooks;
        listBooks = mActivityTestRule.getActivity().getListBooks();
